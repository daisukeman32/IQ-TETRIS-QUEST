...
// 敵キャラ設定（可愛いバージョン）
const enemySettings = {
    easy: { name: 'ふわふわうさぎ', emoji: '🐰', maxHp: 50 },
    normal: { name: 'きらきらねこ', emoji: '🐱', maxHp: 100 },
    hard: { name: 'ゆめゆめユニコーン', emoji: '🦄', maxHp: 150 },
    extra: { name: 'まほうのプリンセス', emoji: '👸', maxHp: 200 }
};
const allQuizzes = {
    lowerElem: [
        // 算数（足し算・引き算のみ）
        ...
        { q: 'おすしに使う白いごはんの名前は？', o: ['しゃり', 'ネタ', 'のり'], a: 'しゃり' },
        ...
        // ○×クイズ
        { q: 'パンダは白と黒のもようがある？', o: ['○', '×'], a: '○' },
        { q: 'さくらは秋にさく花？', o: ['○', '×'], a: '×' },
        { q: 'ぞうは大きな耳と長い鼻をもっている？', o: ['○', '×'], a: '○' },
        { q: 'さかなは木にすんでいる？', o: ['○', '×'], a: '×' },
        { q: 'たいようは夜にしかでてこない？', o: ['○', '×'], a: '×' },
        { q: 'きつねは犬のなかま？', o: ['○', '×'], a: '○' },
        { q: 'ペンギンは南極でくらしている？', o: ['○', '×'], a: '○' },
        { q: 'りんごは野菜？', o: ['○', '×'], a: '×' },
        { q: 'カメはすばやく走るのがとくい？', o: ['○', '×'], a: '×' },
        { q: 'ねこは足が4本ある？', o: ['○', '×'], a: '○' },
        { q: 'キリンは首が短い？', o: ['○', '×'], a: '×' },
        { q: 'くじらはさかな？', o: ['○', '×'], a: '×' },
        { q: 'てんとうむしは赤と黒のもよう？', o: ['○', '×'], a: '○' },
        { q: 'すいかは夏においしいくだもの？', o: ['○', '×'], a: '○' },
        { q: 'ひよこはちいさいネコ？', o: ['○', '×'], a: '×' },
        { q: 'はとは手紙をはこぶ鳥？', o: ['○', '×'], a: '○' },
        { q: 'つきは太陽のようにあつい？', o: ['○', '×'], a: '×' },
        // なぞなぞ
        ...
        { q: 'パンはパンでも食べられないパンは？', o: ['フライパン', 'あんパン', 'メロンパン'], a: 'フライパン' },
        { q: 'いつもゴホゴホいっている動物は？', o: ['イヌ', 'キツネ', 'ゴリラ'], a: 'ゴリラ' },
    ],
    upperElem: [
        // 算数・計算
        ...
        // 国語・漢字
        { q: '「花」の音読みは？', o: ['はな', 'カ', 'ばな', 'ゲ'], a: 'カ' },
        { q: '「山」の音読みは？', o: ['やま', 'サン', 'かわ', 'セン'], a: 'サン' },
        { q: '「森」は木がいくつ？', o: ['1つ', '2つ', '3つ', '4つ'], a: '3つ' },
    ...
    adult: [
        ...
        { q: 'アンパンマンの好きな食べ物は？', o: ['あんパン', 'カレーパン', 'ない', 'つぶあん'], a: 'ない' },
        { q: '南極でかかりにくい病気は？', o: ['インフルエンザ', '風邪', '胃腸炎', '頭痛'], a: '風邪' },
        { q: '日本で一番多い店は？', o: ['コンビニ', '美容院', '飲食店', 'ドラッグストア'], a: '美容院' },
        { q: 'ムーミン・ジャムおじさん・バタコさんの正体は？', o: ['人間', '妖精', '動物', 'ロボット'], a: '妖精' },
        ...
        { q: '世界で最初にカレーライスを食べた日本人は？', o: ['福沢諭吉', '坂本龍馬', '山岡鉄舟', '西郷隆盛'], a: '山岡鉄舟' },
    ...
    extra: [
        ...
        // 計算
        { q: '√144=?', o: ['10', '11', '12', '13'], a: '12' },
        { q: '2の10乗は？', o: ['512', '1024', '2048', '4096'], a: '1024' },
        { q: '17×19=?', o: ['303', '313', '323', '333'], a: '323' },
        { q: '13×17=?', o: ['201', '211', '221', '231'], a: '221' },
        { q: '円周率πの小数2桁目までは？', o: ['3.12', '3.14', '3.16', '3.18'], a: '3.14' },
        // 歴史
        ...
        // 英語
        { q: '「GDP」のDは何の略？', o: ['Development', 'Domestic', 'Demand', 'Distribution'], a: 'Domestic' },
        ...
        // 追加問題（20問）
        { q: '円周率πの小数点以下3桁目は？', o: ['1', '4', '5', '9'], a: '1' },
        { q: 'フィボナッチ数列の8番目は？', o: ['13', '21', '34', '55'], a: '21' },
        ...
        { q: '√2の近似値は？', o: ['1.414', '1.618', '1.732', '2.236'], a: '1.414' },
        { q: '黄金比の近似値は？', o: ['1.414', '1.618', '1.732', '2.236'], a: '1.618' },
        ...
        { q: '3の5乗は？', o: ['125', '243', '343', '512'], a: '243' },
